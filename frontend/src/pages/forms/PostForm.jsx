					...
					<div className="flex flex-col  max-w-2xl p-4 bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
						<form onSubmit={onSubmit}>
							<div className="p-2 overflow-y-auto">
								...
								<input type="text" value={post.title} onChange={ev => setpost({ ...post, title: ev.target.value })} className="py-3 px-4 block w-full rounded-md text-sm border border-gray-400 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400" placeholder="Enter title" />
							</div>
							<div className="p-2 overflow-y-auto">
